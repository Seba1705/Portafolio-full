const seccionesPagina = new fullpage('#fullpage',{
    ...
    anchors: ['inicio', 'sobre-mi', 'proyectos','contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
    navigationTooltips: ['Inicio', 'Sobre mi', 'Proyectos', 'Contacto'], // Tooltips que mostrara por cada boton.
